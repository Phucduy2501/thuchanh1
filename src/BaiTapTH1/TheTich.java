...
public class TheTich extends javax.swing.JFrame {
    public TheTich() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Chuyển đổi đơn vị thể tích");

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel2.setText("Nhập số");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "m³", "dm³", "cm³", "mm³", "lít", "ml" }));

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "m³", "dm³", "cm³", "mm³", "lít", "ml" }));
...
private double convertUnits(double value, String from, String to) {
  double[] conversionFactors = {1.0, 0.001, 0.000001, 0.000000001, 0.001, 0.000001};
String[] units = {"m³", "dm³", "cm³", "mm³", "lít", "ml"};
